...
var introGame = {
    ...
    init: function(){
        ...
        $('.intro-game .tiles-container').sortable({
            delay: 200,
            revert: true,
            revertDuration: 600,
...
var img, pic_real_width, pic_real_height, tWidth, tHeight, origRatio, $tilesContainer, newHeight;
var getOriginalSize = function(){
    ...
    $("<img/>") // Make in memory copy of image to avoid css issues
        ...
        .load(function() {
            ...
            newHeight = window.innerWidth / origRatio;

            if (newHeight > window.innerHeight) {
                $tilesContainer.addClass('height').removeClass('width');
            } else {
                $tilesContainer.addClass('width').removeClass('height');
            }
        });
